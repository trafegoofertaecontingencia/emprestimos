...
export default function Dashboard() {
  ...
  loans.forEach(loan => {
    ...
    const diasDesdeUltimo = Math.floor((hoje - new Date(ultimo)) / (1000 * 60 * 60 * 24));

    if (diasDesdeUltimo >= loan.termDays) {
      vencidos++;
    } else {
      emDia++;
    }
